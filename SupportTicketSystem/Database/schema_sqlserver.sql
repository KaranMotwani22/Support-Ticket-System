...
-- ============================================================
-- 7. SEED DATA
-- Passwords below are BCrypt hashes generated by the API on
-- first startup. The hashes here are REAL valid BCrypt hashes:
--   admin / support1  → password: admin123
--   john.doe / jane.smith → password: user123
-- ============================================================
...
('admin',
 ...
 'System Administrator', 'admin@company.com', 'Admin'),

('support1',
 '$2a$11$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2uheWG/igi.',
 'Support Agent One', 'support1@company.com', 'Admin'),

('john.doe',
 '$2a$11$KzDLHcHsNPTPAODmCBYZyOqPFIBrxVCMIBgPDGjzBaEm8ztjZ5s2K',
 'John Doe', 'john.doe@company.com', 'User'),

('jane.smith',
 '$2a$11$KzDLHcHsNPTPAODmCBYZyOqPFIBrxVCMIBgPDGjzBaEm8ztjZ5s2K',
 'Jane Smith', 'jane.smith@company.com', 'User');
GO
